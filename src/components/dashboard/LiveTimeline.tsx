...
export function LiveTimeline() {
    ...
    if (isLoading) {
        return (
            <div className="p-6 rounded-2xl bg-card border border-card-border backdrop-blur-sm">
        ...
        return (
            <div className="p-6 rounded-2xl bg-card border border-card-border backdrop-blur-sm">
                ...
                <div className="text-center py-6">
                    <p className="text-muted mb-4">Nenhum plano para hoje</p>
                    <button
    ...
    return (
        <div className="p-6 rounded-2xl bg-card border border-card-border backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center justify-between w-full sm:w-auto gap-3">
                    ...
                    <div className="flex items-center gap-3 ml-auto sm:ml-0">
                        ...
                        <span className="text-2xl font-bold text-foreground tabular-nums tracking-tight">{timeString}</span>
                    </div>
                </div>
            </div>
            ...
            {currentBlock ? (
                ...
                <div className="mb-4 p-4 rounded-xl bg-surface text-center">
                    <p className="text-muted text-sm">Nenhum bloco ativo no momento</p>
                </div>
            )}
            ...
            <Link
                href="/agenda"
                className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-surface hover:bg-foreground/5 text-muted text-sm transition-colors"
            >
                Ver agenda completa
