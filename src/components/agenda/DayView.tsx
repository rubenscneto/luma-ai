    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl bg-surface border border-card-border/50 p-6"
            >
                {/* Header */}
    ...
    return (
        ...
        >
            <motion.div
                ...
                animate={{ scale: 1, opacity: 1 }}
                exit={{ scale: 0.95, opacity: 0 }}
                className="w-full max-w-sm p-6 rounded-2xl bg-surface border border-card-border/50"
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-foreground/10 hover:bg-foreground/20 text-foreground transition-colors"
                    >
